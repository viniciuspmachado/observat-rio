  ...
  return (
    <div>
      ...
      <article id="upa" className="container" style={{"background": "none"}}>
                ...
                <div className="row">
                    <div className="col">
                    <h1 style={fontStyle}>Fluxograma da atenção primária a pacientes com tuberculose no Estado do Piauí.<i className="fas fa-info-circle align-top"></i></h1>
                        <br/>
                    </div> 
                </div>
                <section className="d-none d-block d-sm-none d-md-block d-lg-block d-xl-block mg-bm">
                    ...
                    <div className="col-3">
                            <div className="d-flex justify-content-center">
                                ...
                                <CaixaAzul text={[<br/>,'Campanha',<br/>,<br/>]}
                        ...
                        <div className="col-3">
                            <SetaAbaixoCurta />
                            <CaixaAzul text={[<br/>, 'Busca Ativa',<br/>,<br/>]} />
                            <LinhaVert/>
                        ...
                        <div className="col-3">
                            ...
                            <CaixaAzul text={[<br/>, 'Encaminhado por ACS',<br/>,<br/>]} />
                                <LinhaVert/>
                        </div>
                    ...
                    <div className="row">
                        <div className="offset-3 col-6 n-pad">
                            ...
                            <div className="col-6">
                                ...
                                <CaixaBranca text={['Descartado para TB', <sup>*</sup>]}/>
                                <SetaAbaixoCurta/>
                                <CaixaLaranjaLink text={['Investigar Outras Causas']} link='/Turb2'/>
                            </div>
                            ...
                            <div className="col-6">
                                ...
                                <CaixaBranca text={['Confirmado TB', <sup>*</sup>]}/>
                                <div className="col-12">
                                    <div className="d-flex justify-content-center">
                                        <span className="vertical-line arrow-bottom">.</span>
                                    </div>
                                    <CaixaCinza text={['- Notificar;',<br/>,
                                                        '- Iniciar esquema básico', <br/>,
                                                        '- TDO;- Supervisionar tratamento']}/>
                                    
                                    <SetaAbaixoCurta/>
                                    <CaixaLaranjaLink text={['-Regular caso com comorbidade ou efeito adverso maiores para Referência secundária;', <br/>,
                                                            '- Regular paciente menor de 10 anos para Referência', <br/>,
                                                            'Infantil e ou atenção hospitalar especializada;', <br/>,
                                                            ' - Alta por cura de caso sem complicações.']} 
                                                            link='/Turb1' />
                    ...
                    <div className="row">
                        <div className="col d-flex align-items-start flex-column bd-highlight mb-3 mt-4" >
                            <h4 className="legend" style={{"fontSize": "80%"}}>Legenda:</h4>
                                ...
                                <p className="legend mb-0" style={{"fontSize": "80%"}}><strong>TB: </strong>Tuberculose</p>
                                <p className="legend mb-0" style={{"fontSize": "80%"}}><strong>TRM: </strong>Teste Rápido Molecular</p>
                                <p className="legend mb-0" style={{"fontSize": "80%"}}><strong>BK: </strong>Baciloscopia</p>
                                <p className="legend mb-0" style={{"fontSize": "80%"}}><strong>TDO: </strong>Tratamento Diretamente Observado</p>
                                <p className="legend mb-0" style={{"fontSize": "80%"}}><strong>MNT: </strong>Micobactéria Não Tuberculosa</p>
                                <br/>
                                <p className="legend mb-0" style={{"fontSize": "80%"}}><strong><sup>*</sup></strong>Pessoa com tosse persistente por 3 ou mais semanas</p>
                        </div>
                    </div>
