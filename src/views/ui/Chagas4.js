  ...
  return (
    <div>
      ...
      <article id="upa" className="container" style={{"background": "none"}}>
                    ...
                    <div className="row">
                            <div className="col">
                                <h1 style={fontStyle}>Fluxograma de atenção secundária a pacientes com doença de Chagas no estado do Piauí<a href="#a" id="" className="" target="_self" title="Pacientes com sinais e sintomas sugestivos de Calazar"><i className="fas fa-info-circle align-top"></i></a></h1>
                                <br/>
                            </div> 
                        </div>
                        <section className="d-none d-block d-sm-none d-md-block d-lg-block d-xl-block mg-bm">
                            ...
                            <div className="row">
                                <div className="col-3">
                                    ...
                                    <SetaAbaixoCurta/>
                                    <CaixaLaranjaLink text='Exames para determinação da forma crônica: ECG e Rx tórax, esôfago e cólon e coinfecção por HIV.' link='/chagas5' />
                                </div>
                                ...
                                <div className="col-6">
                                    ...
                                    <SetaAbaixoCurta/>
                                    <CaixaLaranjaLink text={['Retroalimentar os resultados', <br/>,'para atenção primária']} link='/chagas1'/>
                                </div>
